...
{
translate([9.362500,6.400000,1.200000])rotate([0,0,-90.000000])m2(part,hole,block,casetop); // D1 (back)
};
...
{
translate([6.362500,5.965000,1.200000])rotate([0,0,90.000000])m7(part,hole,block,casetop); // U3 (back)
};
