...
#define	MAXAPPS 10
   ...
   {                            // Main loop
      ...
      for (unsigned int i = 0; i < MAXAPPS; i++)
		 ...
		 { // Cycle the colour
			 active[i].colour.r=sin256[(active[i].cycle)&255];
			 active[i].colour.g=sin256[(active[i].cycle+85)&255];
			 active[i].colour.b=sin256[(active[i].cycle+170)&255];
		 }
